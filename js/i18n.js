...
const i18n = {
  ...
  ms: {
    ...
    'services.s1.title':   'Machine Learning',
    'services.s1.desc':    'Kami design, train, dan deploy model ML guna data anda sendiri. MLOps pipeline kami pastikan model accurate, reproducible, dan auto-improve — dari eksperimen sampai production dengan CI/CD penuh.',
    'services.s2.title':   'Pemprosesan Bahasa (NLP)',
    'services.s2.desc':    'Buka nilai dari text yang tak berstruktur. Sentiment analysis, classify dokumen, named entity recognition, summarize 1000 review, chatbot fine-tuned untuk konteks anda.',
    'services.s3.title':   'Computer Vision',
    'services.s3.desc':    'Object detection, face recognition, anomaly detection. Integrate dengan kamera existing dan edge hardware anda — real-time visual intelligence tanpa hire surveillance team.',
    'services.s4.title':   'Predictive Analytics',
    'services.s4.desc':    'Bukan sekadar dashboard. Kami bina forecasting engine yang bukan hanya predict apa akan jadi, tapi recommend tindakan terbaik — untuk finance, supply chain, dan operations.',
    'services.s5.title':   'Automasi Proses',
    'services.s5.desc':    'Combine RPA dengan AI reasoning untuk handle dokumen, approval routing, exception. Kerja yang ambil berhari-hari jadi beberapa saat. Auto-update Excel, parse email, generate invoice.',
    'services.s6.title':   'AI Audit &amp; Strategy',
    'services.s6.desc':    'Untuk syarikat yang baru start AI: kami advisory, draft AI roadmap, data strategy, dan framework governance. Pastikan deployment etikal dan compliant.',
    'services.card.link':  'Tanya kami',

    'services.p1.desc':    'Kami audit data anda, objektif perniagaan, dan infrastruktur teknikal. Output: roadmap AI yang jelas dengan milestone yang boleh diukur.',
    'services.p2.desc':    'Rapid prototyping dalam sprint 2 minggu dengan demo. Keputusan architecture dibincang sama-sama — tak hide behind closed doors.',
    'services.p3.desc':    'Production-grade model development. Automated testing, security hardening, staged rollout — zero downtime bila go live.',
    'services.p4.desc':    'Monitoring dashboard, review prestasi bulanan, dan update model berterusan. Kami stay sebagai partner lepas launch.',
    ...
    'pricing.addon1.desc':  'Workshop sehari penuh, hands-on untuk pasukan engineering dan data anda. Cover ML fundamentals, MLOps, dan prompt engineering. Sampai 20 attendees.',
    'pricing.addon2.title': 'Audit AI',
    'pricing.addon2.desc':  '2 minggu deep-dive untuk AI system yang anda dah ada. Kami assess prestasi model, data quality, gap governance. Output: laporan bertulis.',
    'pricing.addon3.title': 'LLM Fine-tuning',
    'pricing.addon3.desc':  'Fine-tune LLM open-source pada data khusus anda. Termasuk data preparation, training, evaluation, dan model artefact yang ready deploy.',
    ...
    'contact.p1.title':      'Auto-confirm',
    'contact.p1.desc':       'Anda dapat confirmation auto sekejap je. Lepas tu kami balas personal dalam 1 hari bekerja.',
    'contact.p2.title':      'Discovery call',
    'contact.p2.desc':       'Call 30 minit untuk faham data anda, matlamat perniagaan, timeline, dan constraint. Tak ada sales pitch — kami dengar je.',
    'contact.p3.title':      'Cadangan',
    'contact.p3.desc':       'Dalam 5 hari bekerja lepas discovery call, anda dapat cadangan bertulis — approach, pasukan, timeline, harga fixed.',
    'contact.p4.title':      'Keputusan anda',
    'contact.p4.desc':       'Ambil masa anda. Cadangan kami valid 30 hari, takde fake urgency. Yang penting keputusan dibuat dengan jelas.',
