...
const i18n = {
  ...
  ms: {
    ...
    'index.hero.desc': 'Studio AI kecil dari Kota Bharu. Jika perniagaan anda ada masalah — jualan lembap, stok salah, pelanggan hilang — beritahu kami. Kami akan tengok, bina, dan bagi sistem yang betul-betul jalan.',
    'index.hero.btn1': 'Beritahu masalah anda',
    'index.hero.btn2': 'Perkhidmatan kami',

    'index.cap.label': 'Perkhidmatan',
    'index.cap.title': 'Enam bidang <span>yang kami buat</span>',
    'index.cap.desc':  'Bukan semua AI sesuai untuk perniagaan anda. Ini perkhidmatan yang kami sudah buat untuk klien sebenar. Minta untuk lihat contoh kerja, kami boleh tunjukkan.',
    'index.cap.ml.title':        'Pembelajaran Mesin',
    'index.cap.ml.desc':         'Model yang belajar dari data anda sendiri. Contohnya: agak pelanggan mana akan habis stok minggu depan, atau tangkap transaksi yang mencurigakan dari ratusan urus niaga sehari.',
    'index.cap.nlp.title':       'Pemprosesan Bahasa',
    'index.cap.nlp.desc':        'Sistem yang faham Bahasa Malaysia, Inggeris, dan campuran. Boleh susun e-mel pelanggan ikut jenis, kelaskan aduan, atau ringkaskan 1,000 ulasan kepada 5 poin penting.',
    'index.cap.cv.title':        'Penglihatan Komputer',
    'index.cap.cv.desc':         'Kamera ditambah dengan AI untuk kira barang masuk gudang, baca nombor plat kereta, atau tangkap pembungkusan rosak. Tak perlu staf duduk pandang skrin 8 jam.',
    'index.cap.analytics.title': 'Analitik Ramalan',
    'index.cap.analytics.desc':  'Beritahu anda apa yang mungkin berlaku minggu depan. Stok akan habis bila, pelanggan mana akan hilang, waktu puncak pukul berapa.',
    'index.cap.auto.title':      'Automasi Proses',
    'index.cap.auto.desc':       'Buat invois sendiri dari pesanan WhatsApp. Kemas kini Excel apabila ada e-mel pesanan baru. Kerja yang berulang 50 kali sehari, biar mesin buat.',
    'index.cap.sec.title':       'Audit AI',
    'index.cap.sec.desc':        'Anda dah pakai AI tapi tak puas hati? Kami audit. Cari mana yang kurang tepat, baiki arahan yang lemah, dan sediakan dokumen yang anda boleh ambil alih sendiri.',

    'index.ben.label':   'Bila AI Berguna',
    'index.ben.title':   'Bila AI memang <span>berbaloi</span>',
    'index.ben.desc':    'AI bukan magik. Untuk jenis kerja tertentu sahaja ia berbaloi. Ini contoh sebenar.',
    'index.ben.1.title': 'Jimat masa untuk kerja berulang',
    'index.ben.1.desc':  'Kerja yang anda ulang setiap hari — salin data, buat laporan, balas mesej standard — AI boleh uruskan. Staf anda fokus pada kerja yang perlukan otak manusia.',
    'index.ben.2.title': 'Keputusan lebih cepat',
    'index.ben.2.desc':  'Jika perlu tunggu Excel siap dulu baru boleh buat keputusan, anda sudah ketinggalan. AI proses ribuan baris dalam beberapa saat — anda baca ringkasan sahaja.',
    'index.ben.3.title': 'Pelanggan tak perlu menunggu',
    'index.ben.3.desc':  'Pelanggan WhatsApp tanya pukul 3 pagi pasal pesanan — chatbot anda jawab terus. Hanya soalan yang rumit diserah pada staf esok pagi.',
    'index.ben.4.title': 'Pesaing anda sudah mula',
    'index.ben.4.desc':  'Kedai dalam talian sebelah sudah pakai AI untuk cadang produk. Jika anda tunggu lagi setahun dua, jurang akan jadi terlalu jauh untuk dikejar.',
    'index.ben.5.title': 'Berkembang tanpa tambah staf',
    'index.ben.5.desc':  'Sama ada 100 atau 10,000 pesanan sehari, sistem yang sama digunakan. Tak perlu upah 100 admin tambahan — uruskan apa yang AI tak boleh selesai sahaja.',
    'index.ben.6.title': 'Rancang guna data, bukan agakan',
    'index.ben.6.desc':  'Berapa banyak stok nak tempah bulan depan? Bila masa nak keluarkan bajet iklan? Berdasarkan trend sebenar perniagaan anda, bukan rasa hati.',
    ...
    'index.cta.desc':  'Hantar mesej. Kami balas dalam 24 jam. Jika AI bukan jawapannya, kami akan beritahu terus.',
    ...
    'about.hero.desc':  'AI Solution baru sahaja bermula. Kami sedang cari klien pertama untuk bina sistem AI yang betul-betul jalan. Jika anda sanggup beri peluang pada studio baru yang teliti, kami di sini.',

    'about.mission.label': 'Misi Kami',
    'about.mission.title': 'AI patut <span>memudahkan kerja</span>, bukan tambah masalah',
    'about.mission.p1':    'AI Solution mula dengan satu prinsip — kebanyakan syarikat dijual janji AI yang tak siapa boleh tepati. Konsultan hantar slide. Vendor jual alat one-size-fits-all. Tiada yang bagi nilai sebenar pada perniagaan.',
    'about.mission.p2':    'Kami bina AI Solution untuk jadi rakan kerja yang ideal — jurutera praktikal yang faham konteks perniagaan, cakap dengan jelas tanpa jargon, dan ukur kejayaan ikut hasil anda, bukan jam yang kami tagih.',
    'about.mission.btn':   'Mulakan projek',

    'about.values.label':   'Prinsip Kami',
    'about.values.title':   'Apa yang <span>kami pegang</span>',
    'about.values.desc':    'Ini bukan poster di pejabat. Ini prinsip yang menentukan projek yang kami terima, cara kami cakap dengan klien, dan sebab kami tolak kerja yang tak sesuai.',
    'about.val.1.title':    'Hasil, bukan output',
    'about.val.1.desc':     'Kami ukur kejayaan ikut hasil perniagaan yang kami bagi. Bukan ikut baris kod, model yang dilatih, atau slide yang kami hantar. Jika kerja kami tak bagi impak pada anda, kami akan beritahu awal.',
    'about.val.2.title':    'Komunikasi jujur',
    'about.val.2.desc':     'Kami beritahu data anda boleh sokong apa, dan tak boleh sokong apa. Kami tunjuk risiko sebelum jadi masalah. Kami kongsi metrik secara terbuka — walaupun bila hasilnya kurang memuaskan.',
    'about.val.3.title':    'Bina dengan tanggungjawab',
    'about.val.3.desc':     'Setiap model yang kami bina dinilai untuk bias dan kesan jangka panjang. Kami tolak projek yang berisiko bagi mudarat, walaupun bayarannya tinggi.',
    'about.val.4.title':    'Sebahagian pasukan anda',
    'about.val.4.desc':     'Kami kerja sebagai sebahagian dari pasukan anda — beri latihan pada jurutera anda, dan tulis dokumen untuk setiap proses. Bila kontrak tamat, ilmu kekal dengan anda, bukan dengan kami.',
    'about.val.5.title':    'Pantas tapi teliti',
    'about.val.5.desc':     'Prototaip pantas bukan alasan untuk kerja yang lemah. Kami gerak laju guna rangka kerja yang sudah teruji — kod siap-guna yang stabil walaupun dalam beban kerja sebenar.',
    'about.val.6.title':    'Faham konteks tempatan',
    'about.val.6.desc':     'Berpusat di Kota Bharu, kami faham konteks perniagaan Malaysia. Kami reka untuk pengguna sebenar (bukan persona generik) dan peraturan tempatan dari hari pertama.',
    ...
    'about.culture.desc':  'Kami pilih orang yang ingin tahu, bukan resume yang penuh kata kunci. Setiap ahli pasukan ada bajet pembelajaran sendiri, ikut perkembangan terkini dalam AI, dan sumbang pada projek sumber terbuka.',
    'about.culture.li1':   'Setiap projek ada satu pakar kanan yang bertanggungjawab — tak diserah pada junior tanpa pengawasan',
    'about.culture.li2':   'Berpusat di Kota Bharu, boleh kerja jarak jauh — boleh jumpa kalau perlu',
    'about.culture.li3':   'Kami terima projek yang kami faham, tolak yang tak — lebih jimat untuk anda',
    'about.culture.li4':   'Setiap penyerahan ada dokumen lengkap yang boleh anda uruskan sendiri',
    'about.culture.btn':   'Hubungi kami',

    'about.cta.title': 'Ada projek <span>nak dibina?</span>',
    'about.cta.desc':  'Hantar mesej dengan masalah anda. Kami balas dalam 24 jam. Jika projek tak sesuai untuk kami, kami cadangkan pihak lain yang lebih sesuai.',
    ...
    'services.hero.desc':  'Setiap perkhidmatan di bawah ada portfolio (boleh minta tengok). Kami bina dari awal, atau ambil alih projek AI yang sebelum ini tak berjaya.',

    'services.port.label': 'Senarai Perkhidmatan',
    'services.port.title': 'Enam bidang kerja. <span>Satu pasukan.</span>',
    'services.port.desc':  'Kami bukan generalis. Kami pakar dalam 6 bidang ini sahaja. Untuk yang lain, kami rujuk anda pada rakan kerja yang lebih sesuai.',
    'services.s1.title':   'Pembelajaran Mesin',
    'services.s1.desc':    'Kami reka, latih, dan guna pakai model ML berdasarkan data anda. Sistem MLOps kami pastikan model kekal tepat dan tambah baik sendiri — dari eksperimen hingga ke versi sebenar dengan CI/CD penuh.',
    'services.s2.title':   'Pemprosesan Bahasa (NLP)',
    'services.s2.desc':    'Manfaatkan data teks yang tak berstruktur. Analisis sentimen, kelaskan dokumen, kenal pasti nama dan tempat, ringkaskan 1,000 ulasan, dan chatbot yang ditala khas untuk perniagaan anda.',
    'services.s3.title':   'Penglihatan Komputer',
    'services.s3.desc':    'Kesan objek, kenal pasti wajah, tangkap anomali. Diintegrasikan dengan kamera dan peranti yang sudah ada — pemantauan visual masa nyata tanpa upah pasukan pengawasan.',
    'services.s4.title':   'Analitik Ramalan',
    'services.s4.desc':    'Lebih dari papan pemuka biasa. Kami bina enjin ramalan yang bukan sahaja agak apa akan berlaku, tapi cadang tindakan terbaik — untuk kewangan, rantaian bekalan, dan operasi.',
    'services.s5.title':   'Automasi Proses',
    'services.s5.desc':    'Gabungan RPA dan AI untuk uruskan dokumen, laluan kelulusan, dan kes pengecualian. Proses yang ambil masa berhari-hari boleh dikurangkan kepada beberapa saat. Kemas kini Excel, hurai e-mel, jana invois — semua secara automatik.',
    'services.s6.title':   'Audit &amp; Strategi AI',
    'services.s6.desc':    'Untuk syarikat yang baru mula dengan AI: kami bagi khidmat nasihat, sediakan peta jalan AI, strategi data, dan rangka kerja tadbir urus. Pastikan pelaksanaan beretika dan ikut peraturan.',
    'services.card.link':  'Tanya kami',

    'services.p1.desc':    'Kami audit data, matlamat perniagaan, dan infrastruktur teknikal anda. Hasilnya: peta jalan AI yang jelas dengan pencapaian yang boleh diukur.',
    'services.p2.desc':    'Bina prototaip pantas dalam 2 minggu setiap fasa, dengan sesi demonstrasi. Keputusan reka bentuk dibincang terbuka — bukan di sebalik tabir.',
    'services.p3.desc':    'Bina model pada tahap sebenar. Ujian automatik, keselamatan dikuatkan, pelancaran berperingkat — tiada gangguan bila sistem mula digunakan.',
    'services.p4.desc':    'Papan pemuka pemantauan, semakan prestasi bulanan, dan kemas kini model berterusan. Kami kekal sebagai rakan kongsi walaupun selepas pelancaran.',
    ...
    'services.p3.title': 'Pembinaan (4–6 minggu)',
    'services.p4.title': 'Selepas pelancaran',

    'services.cta.title': 'Ada masalah nak diselesaikan?',
    'services.cta.desc':  'Hantar mesej tentang masalah anda. Kami balas dalam 24 jam dengan cadangan awal — percuma, tanpa komitmen.',
    ...
    'pricing.hero.desc':  'Audit awal percuma untuk semua pelan. Boleh batal bila-bila masa. Semua harga dalam Ringgit Malaysia, dibayar setiap bulan.',

    'pricing.plans.label': 'Pelan Langganan',
    'pricing.plans.title': 'Pelan ikut <span>saiz syarikat</span>',
    'pricing.plans.desc':  'Mula dengan pelan Permulaan untuk uji, kemudian naik ke Profesional bila sudah bersedia. Pelan Korporat sesuai untuk syarikat yang perlu pasang sistem di tempat sendiri atau ada keperluan pematuhan khas.',
    ...
    'pricing.addons.title': 'Tambahan <span>jika perlu</span>',
    'pricing.addons.desc':  'Jika pelan asas tak cukup untuk keperluan anda, boleh tambah perkhidmatan satu per satu ikut keperluan sebenar.',
    'pricing.addon1.title': 'Bengkel Latihan AI',
    'pricing.addon1.desc':  'Bengkel sehari penuh, secara praktikal, untuk pasukan teknikal dan data anda. Cover asas pembelajaran mesin, MLOps, dan cara tulis arahan AI. Sehingga 20 peserta.',
    'pricing.addon2.title': 'Audit AI',
    'pricing.addon2.desc':  'Penilaian 2 minggu untuk sistem AI yang anda dah ada. Kami nilai prestasi model, kualiti data, dan jurang dalam tadbir urus. Hasil: laporan bertulis yang lengkap.',
    'pricing.addon3.title': 'Penalaan LLM',
    'pricing.addon3.desc':  'Tala LLM sumber terbuka guna data khusus anda. Termasuk penyediaan data, latihan, penilaian, dan model siap-guna yang boleh terus dipakai.',
    ...
    'pricing.cta.desc':  'Hantar mesej tentang masalah anda. Kami akan cadang pelan yang sesuai — atau beritahu jika anda belum perlukan khidmat kami.',
